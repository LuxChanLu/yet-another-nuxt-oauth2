context('Auth flow', () => {
  ...
  it('should login, wait expire notice and logout', () => {
    ...
    cy.tick(3000 * 1000).tick(550 * 1000).wait(1000).then(() => expect(stub.getCall(0)).to.be.calledWith('Token gonna expire !'))
  ...
  it('should login, wait expire notice and refresh', () => {
    ...
    cy.tick(3000 * 1000).tick(550 * 1000).wait(1000)

    cy.get('button[data-cy="token-refresh"]').should('be.visible').click().wait(1000).tick(1000)
